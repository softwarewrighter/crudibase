...
### Deployment Spike: Deploy MVP to Test Server (High Priority - Week 9)
...
- [ ] Provision server or cloud service account
- [ ] Setup Node.js 22 on server
- [ ] Configure firewall and security groups
- [ ] Research hosting requirements (memory, CPU, storage)

#### Application Configuration

- [ ] Create production `.env` file with secrets
- [ ] Setup production database (SQLite file or migrate to PostgreSQL)
- [ ] Configure CORS for production domain
- [ ] Update frontend API URLs for production (environment variables)
...
- [ ] Upload backend build to server
- [ ] Upload frontend build (static hosting or serve from backend)
...
- [ ] Setup DNS records pointing to server
...
- [ ] Setup database backups (daily cron job or backup service)
...
- [ ] Test Wikibase search endpoint
- [ ] Test collections CRUD (create, view, add items, delete)
...
- [ ] Performance testing (measure page load, API response times)
- [ ] Check for console errors in browser

#### Monitoring & Logging

- [ ] Setup application logging (Winston or Pino)
- [ ] Configure log rotation (PM2 or logrotate)
- [ ] Setup error tracking (Sentry or similar - optional for MVP)
- [ ] Create health check endpoint (`GET /health`)
- [ ] Setup uptime monitoring (UptimeRobot or similar)
- [ ] Document server access (SSH keys, credentials)
...
**Deliverable**: Publicly accessible MVP at production URL with HTTPS

**Success Criteria**:

- [ ] Application accessible via HTTPS domain
- [ ] 3+ beta testers successfully register and use app
...
### Sprint 5.5: MVP Polish & Testing (Week 10)
